                ...
                <ul class="hidden lg:flex items-center gap-6">
                    ...
                    <li class="nav-item relative">
                        ...
                        <div class="dropdown-menu absolute top-full left-0 mt-2 w-64">
                            ...
                            <div class="relative bg-white rounded-lg shadow-xl overflow-hidden py-2">
                                ...
                                <a href="../pages/visi-misi.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-bullseye w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="sejarah.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-book w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                        <div class="font-medium text-gray-900 group-hover:text-blue-600">Sejarah Sekolah</div>
                                        <div class="text-xs text-gray-500">Sejarah Singkat</div>
                                    </div>
                                </a>
                                <a href="struktur-organisasi.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-sitemap w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="tenaga-pendidik.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-user-tie w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                        <div class="font-medium text-gray-900 group-hover:text-blue-600">Tenaga Pendidik</div>
                                        <div class="text-xs text-gray-500">Guru & Staff</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <li class="nav-item relative">
                        ...
                        <div class="dropdown-menu absolute top-full left-0 mt-2 w-64">
                            <div class="dropdown-arrow"></div>
                            <div class="relative bg-white rounded-lg shadow-xl overflow-hidden py-2">
                                <a href="kurikulum.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-book-open w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="program-unggulan.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-award w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="kalender-akademik.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-calendar-alt w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="ekstrakurikuler.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-users w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                    ...
                    <li class="nav-item relative">
                        ...
                        <div class="dropdown-menu absolute top-full left-0 mt-2 w-64">
                            <div class="dropdown-arrow"></div>
                            <div class="relative bg-white rounded-lg shadow-xl overflow-hidden py-2">
                                <a href="info-ppdb.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-info-circle w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="syarat-pendaftaran.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-file-alt w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="alur-pendaftaran.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-route w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="daftar-online.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-edit w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                    ...
                    <li class="nav-item relative">
                        ...
                        <div class="dropdown-menu absolute top-full left-0 mt-2 w-64">
                            <div class="dropdown-arrow"></div>
                            <div class="relative bg-white rounded-lg shadow-xl overflow-hidden py-2">
                                <a href="berita.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-newspaper w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="pengumuman.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-bullhorn w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="agenda.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-calendar-check w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                                ...
                                <a href="prestasi.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-50 transition-colors group"><i class="fas fa-trophy w-5 transition-transform group-hover:text-blue-600"></i>
                                    <div>
                    ...
                    <li><a href="galeri.php" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Galeri</a></li>
                    <li><a href="kontak.php" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Kontak</a></li>
        ...
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <div class="mobile-dropdown">
                    ...
                    <div class="mobile-dropdown-content max-h-0 overflow-hidden transition-all duration-300">
                        <div class="pl-4 pt-2 space-y-1 border-l-2 border-blue-200 ml-6">
                            <a href="profil-sekolah.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Profil Sekolah</a>
                            <a href="../pages/visi-misi.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Visi & Misi</a>
                            <a href="sejarah.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Sejarah Sekolah</a>
                            <a href="struktur-organisasi.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Struktur Organisasi</a>
                            <a href="tenaga-pendidik.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Tenaga Pendidik</a>
                        </div>
                    </div>
                </div>
                <div class="mobile-dropdown">
                    ...
                    <div class="mobile-dropdown-content max-h-0 overflow-hidden transition-all duration-300">
                        <div class="pl-4 pt-2 space-y-1 border-l-2 border-blue-200 ml-6">
                            <a href="kurikulum.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Kurikulum</a>
                            <a href="program-unggulan.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Program Unggulan</a>
                            <a href="kalender-akademik.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Kalender Akademik</a>
                            <a href="ekstrakurikuler.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Ekstrakurikuler</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="mobile-dropdown">
                    ...
                    <div class="mobile-dropdown-content max-h-0 overflow-hidden transition-all duration-300">
                        <div class="pl-4 pt-2 space-y-1 border-l-2 border-blue-200 ml-6">
                            <a href="info-ppdb.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Informasi PPDB</a>
                            <a href="syarat-pendaftaran.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Syarat Pendaftaran</a>
                            <a href="alur-pendaftaran.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Alur Pendaftaran</a>
                            <a href="daftar-online.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Daftar Online</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="mobile-dropdown">
                    ...
                    <div class="mobile-dropdown-content max-h-0 overflow-hidden transition-all duration-300">
                        <div class="pl-4 pt-2 space-y-1 border-l-2 border-blue-200 ml-6">
                            <a href="berita.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Berita</a>
                            <a href="pengumuman.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Pengumuman</a>
                            <a href="agenda.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Agenda</a>
                            <a href="prestasi.php" class="block px-4 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg">Prestasi</a>
                        </div>
                    </div>
                </div>

                <a href="galeri.php" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg font-medium transition-all">
                    <i class="fas fa-images w-5"></i> Galeri
                </a>

                <a href="kontak.php" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg font-medium transition-all">
