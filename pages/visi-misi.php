    ...
    <div class="container mx-auto px-4 py-16 relative z-10">
        ...
        <div class="text-center text-white">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">
                <i class="fas fa-lightbulb mr-3"></i>Visi Misi Sekolah
            </h1>
            <p class="text-lg text-white/90 max-w-2xl mx-auto">
                Menyelenggarakan pendidikan vokasi berkualitas yang menghasilkan lulusan unggul, berkarakter, dan siap bersaing di dunia kerja serta berkontribusi positif bagi masyarakat.
            </p>
        </div>
    </div>
</div>
