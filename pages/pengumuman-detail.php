...
<section class="py-16 px-4 bg-gray-50">
    <div class="max-w-4xl mx-auto">
        ...
        <a href="pengumuman.php" class="inline-flex items-center text-blue-600 hover:text-blue-700 mb-8 transition-colors">
        ...
        <div class="mt-16">
            <h2 class="text-3xl font-bold text-gray-800 mb-8">Pengumuman Lainnya</h2>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">

                <?php foreach ($announcements as $rel): ?>
                    <?php if ($rel['id'] !== $item['id']): ?>
                        <a href="pengumuman-detail.php?id=<?= $rel['id'] ?>" class="block bg-white rounded-xl shadow hover:shadow-lg transition p-6">
                            <h3 class="font-semibold text-gray-800 mb-2"><?= $rel['title'] ?></h3>
                            <p class="text-sm text-gray-500"><?= $rel['date'] ?></p>
                        </a>
                    <?php endif; ?>
                <?php endforeach; ?>
